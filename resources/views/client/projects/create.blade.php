								...
								<div class="row">
									...
									<div class="col-xl-4">
										<div class="submit-field">
											<h5>Job Title</h5>
											<input type="text" class="with-border" name='title' @error('name') is-invalid @enderror>
											@error('name')
									...
									<div class="col-xl-4">
										<div class="submit-field">
											...
											<select class="selectpicker with-border" data-size="7" title="Select Job Type" name="type">
												...
												<option value="{{old($type,$type)}}">{{$type}}</option>
												@endforeach
											</select>
										</div>
									</div>
									...
									<div class="col-xl-4">
										<div class="submit-field">
											...
											<select class="selectpicker with-border" data-size="7" title="Select Category" name="status">
												...
												<option value="{{old($status,$status)}}">{{ $status }}</option>
												@endforeach
											</select>
										</div>
									</div>
											...
											<div class="row">
												...
												<div class="col-xl-12">
													<div class="input-with-icon">
														<input class="with-border" name="budget" type="text" placeholder="budget" @error('budget') is-invalid @enderror>

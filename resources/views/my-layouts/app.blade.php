...
<head>
  ...
  <title>@yield('title','elancer project')</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">

  <link href="{{asset('assets/dashboard/plugins/iconfonts/icons.css')}}" rel="stylesheet" />
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">@yield('title page',config('app.name'))</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
